...
- [x] 2. Implement Settings Manager
  - [x] 2.1 Create AppSettings model with DeviceId, BackendUrl, ApiKey, DefaultPrinterName
    - _Requirements: 8.2, 8.4_
  
  - [x] 2.2 Implement SettingsManager class
...
- [x] 3. Implement Printer Service
  - [x] 3.1 Create ReceiptDto and related DTOs
  ...
  - [x] 3.2 Implement PrinterService class
...
- [x] 4. Implement SignalR Client Service
  - [x] 4.1 Create DTOs for SignalR communication
    - Create PrintCommandDto (CommandId, Receipt)
    - Create PrintCompletedEventDto (CommandId, Success, ErrorMessage, CompletedAt)
    - _Requirements: 3.2, 3.3_
  
  - [x] 4.2 Implement SignalRClientService class
...
- [x] 5. Wire components together in main application
  - [x] 5.1 Create main App class with dependency injection
    - Register ISettingsManager, IPrinterService, ISignalRClientService
    - Initialize services on startup
    - Connect SignalR client on startup
    - _Requirements: 1.1_
  
  - [x] 5.2 Wire print command flow
...
- [x] 6. Implement System Tray UI
  - [x] 6.1 Create SystemTrayManager class
  ...
  - [x] 6.2 Create Settings Window (WPF)
...
- [x] 7. Implement Backend SignalR Hub
  - [x] 7.1 Create DeviceHub class in backend
  ...
  - [x] 7.2 Create DeviceCommandService in backend
  ...
  - [x] 7.3 Add device hub endpoint to backend startup
