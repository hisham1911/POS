...
const builtInThemes: Record<Exclude<AppThemeId, "custom">, ThemeTokens> = {
  light: {
    ...
    muted: "210 22% 95%",
    mutedForeground: "218 14% 39%",
    destructive: "0 72% 56%",
    destructiveForeground: "0 0% 100%",
    success: "153 60% 36%",
    successForeground: "0 0% 100%",
    warning: "42 92% 58%",
    warningForeground: "222 40% 14%",
    border: "214 22% 86%",
    input: "214 22% 86%",
    ring: "214 84% 56%",
    sidebarBackground: "210 27% 97%",
    sidebarForeground: "222 40% 14%",
    sidebarBorder: "214 23% 86%",
    sidebarAccent: "42 92% 58%",
  ...
  dark: {
    ...
    card: "222 28% 14%",
    cardForeground: "210 28% 96%",
    popover: "222 28% 14%",
    popoverForeground: "210 28% 96%",
    primary: "153 58% 48%",
    primaryForeground: "222 35% 10%",
    secondary: "39 90% 63%",
    secondaryForeground: "222 35% 10%",
    accent: "198 82% 60%",
    accentForeground: "222 35% 10%",
    muted: "222 20% 18%",
    mutedForeground: "214 16% 72%",
    destructive: "0 75% 60%",
    destructiveForeground: "210 28% 96%",
    success: "153 58% 48%",
    successForeground: "222 35% 10%",
    warning: "39 90% 63%",
    warningForeground: "222 35% 10%",
    border: "220 18% 24%",
    input: "220 18% 24%",
    ring: "198 82% 60%",
    sidebarBackground: "223 31% 12%",
    sidebarForeground: "210 28% 96%",
    sidebarBorder: "220 18% 24%",
    sidebarAccent: "198 82% 60%",
    shadowColor: "220 60% 2%"
  },
  ocean: {
    background: "204 45% 97%",
    foreground: "215 50% 19%",
    card: "0 0% 100%",
    cardForeground: "215 50% 19%",
    popover: "0 0% 100%",
    popoverForeground: "215 50% 19%",
    primary: "191 72% 35%",
    primaryForeground: "0 0% 100%",
    secondary: "188 62% 58%",
    secondaryForeground: "215 50% 19%",
    accent: "214 76% 55%",
    accentForeground: "0 0% 100%",
    muted: "199 33% 94%",
    mutedForeground: "212 21% 39%",
    destructive: "0 80% 59%",
    destructiveForeground: "0 0% 100%",
    success: "165 54% 38%",
    successForeground: "0 0% 100%",
    warning: "42 92% 58%",
    warningForeground: "215 50% 19%",
    border: "200 28% 85%",
    input: "200 28% 85%",
    ring: "214 76% 55%",
    sidebarBackground: "201 39% 96%",
    sidebarForeground: "215 50% 19%",
    sidebarBorder: "200 28% 85%",
    sidebarAccent: "191 72% 35%",
    shadowColor: "214 62% 17%"
  },
  desert: {
    background: "34 42% 96%",
    foreground: "24 28% 20%",
    card: "36 44% 98%",
    cardForeground: "24 28% 20%",
    popover: "36 44% 98%",
    popoverForeground: "24 28% 20%",
    primary: "19 66% 45%",
    primaryForeground: "0 0% 100%",
    secondary: "40 82% 62%",
    secondaryForeground: "24 28% 20%",
    accent: "160 22% 40%",
    accentForeground: "0 0% 100%",
    muted: "34 26% 92%",
    mutedForeground: "25 16% 40%",
    destructive: "0 75% 58%",
    destructiveForeground: "0 0% 100%",
    success: "160 22% 40%",
    successForeground: "0 0% 100%",
    warning: "40 82% 62%",
    warningForeground: "24 28% 20%",
    border: "34 24% 82%",
    input: "34 24% 82%",
    ring: "19 66% 45%",
    sidebarBackground: "33 34% 94%",
    sidebarForeground: "24 28% 20%",
    sidebarBorder: "34 24% 82%",
    sidebarAccent: "19 66% 45%",
    shadowColor: "20 32% 15%"
  }
};
...
export const getSidebarCss = (preferences: AppPreferences) => {
  if (preferences.sidebarImage) {
    return `linear-gradient(180deg, hsl(var(--sidebar-background) / 0.18), hsl(var(--sidebar-background) / 0.58)), url("${preferences.sidebarImage}")`;
  }

  return "radial-gradient(circle at top, hsl(var(--sidebar-accent) / 0.16), transparent 42%), linear-gradient(180deg, hsl(var(--sidebar-background) / 0.12), transparent 75%)";
};
