        ...
        <div className="bg-white rounded-xl shadow-2xl w-full max-w-md max-h-[85vh] flex flex-col">
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-200 shrink-0">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h2 className="text-base font-bold text-gray-800">منتج مخصص</h2>
                <p className="text-xs text-gray-500">للطلب الحالي فقط</p>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="flex gap-2 p-4 border-t border-gray-200 shrink-0">
            ...
            <button
              ...
              className="flex-1 px-4 py-2.5 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed text-sm"
              disabled={orderId ? isLoading : false}
            >
